...
INSERT INTO `students` (`roll_no`, `name`, `guardian_name`, `class`, `mobile`, `email`, `password`, `remark`) VALUES
(1, 'student1 ', 'father student1 ', 11, 1234567890, 'student1@gmail.com', 1234567890, 'good !but but not the best');
